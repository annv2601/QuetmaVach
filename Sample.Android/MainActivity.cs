...
namespace ChiTra
{
	[Activity (Label = "Quét Mã Vạch", MainLauncher = true, Theme="@android:style/Theme.Holo.Light", ConfigurationChanges=ConfigChanges.Orientation|ConfigChanges.KeyboardHidden)]
	public class Activity1 : Activity
	{
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			buttonScanDefaultView.Click += async delegate {
				...
				scanner.TopText = "Giữ hướng Camera vào ảnh Mã vạch cần quét";
				scanner.BottomText = "Đợi hệ thống tự động quét nhận ra Mã vạch!";
		...
		void HandleScanResult (ZXing.Result result)
		{
			...
			if (result != null && !string.IsNullOrEmpty(result.Text))
				msg = "Mã vạch: " + result.Text;
			else
				msg = "Hủy quét mã vạch!";
